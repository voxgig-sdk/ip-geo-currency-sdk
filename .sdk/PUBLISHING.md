...
|---|---|---|
| `ts/` | @voxgig-sdk/ip-geo-currency-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ip-geo-currency-sdk \
      --repository voxgig-sdk/ip-geo-currency-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ip-geo-currency-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ip-geo-currency-sdk --id=<id>` removes it.
