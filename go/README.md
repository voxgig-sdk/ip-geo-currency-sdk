...
The Golang SDK for the IpGeoCurrency API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/ip-geo-currency-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/ip-geo-currency-sdk=../path/to/github.com/voxgig-sdk/ip-geo-currency-sdk
```
...
| `ApiJson` | `(data map[string]any) IpGeoCurrencyEntity` | Create a ApiJson entity instance. |
...
```
github.com/voxgig-sdk/ip-geo-currency-sdk/
...
The root package (`github.com/voxgig-sdk/ip-geo-currency-sdk`) re-exports everything needed
