...
(0, node_test_1.describe)('CurrencyConversionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpGeoCurrencySDK({
    ...
    (0, node_test_1.test)('direct-load-currency_conversion', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-currency_conversion', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IP_GEO_CURRENCY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpGeoCurrencySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IP_GEO_CURRENCY_TEST_CURRENCY_CONVERSION_ENTID'];
    ...
    const client = new __1.IpGeoCurrencySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CurrencyConversionDirect.test.js.map