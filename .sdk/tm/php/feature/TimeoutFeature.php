...
// IpGeoCurrency SDK timeout feature
...
class IpGeoCurrencyTimeoutFeature extends IpGeoCurrencyBaseFeature
{
    ...
    private function _with_timeout(IpGeoCurrencyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpGeoCurrencyContext $_ctx, float $ms): void
    {
        $client = $this->client;
