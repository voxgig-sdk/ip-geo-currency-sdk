...
The Ruby SDK for the IpGeoCurrency API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `IpGeoCurrencyError` (a `StandardError` subclass), so wrap
