...
// IpGeoCurrency SDK proxy feature
...
class IpGeoCurrencyProxyFeature extends IpGeoCurrencyBaseFeature
{
    ...
    public function init(IpGeoCurrencyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpGeoCurrencyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
