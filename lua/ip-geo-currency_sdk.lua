...
local IpGeoCurrencySDK = {}
IpGeoCurrencySDK.__index = IpGeoCurrencySDK
...
IpGeoCurrencySDK._make_feature = _make_feature


function IpGeoCurrencySDK.new(options)
  local self = setmetatable({}, IpGeoCurrencySDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function IpGeoCurrencySDK:options_map()
...
function IpGeoCurrencySDK:get_utility()
  return Utility.copy(self._utility)
end


function IpGeoCurrencySDK:get_root_ctx()
  return self._rootctx
end


function IpGeoCurrencySDK:prepare(fetchargs)
...
function IpGeoCurrencySDK:direct(fetchargs)
...
-- by passing it.
function IpGeoCurrencySDK:_raw_request(fetchargs)
  local utility = self._utility
...
function IpGeoCurrencySDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "IpGeoCurrencySDK: graphql: " .. msg
    res.graphql = errors
  end
...
function IpGeoCurrencySDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = IpGeoCurrencySDK.new(sdkopts)
  sdk.mode = "test"
