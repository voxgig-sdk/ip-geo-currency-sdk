...
func NewApiJsonEntity(client *core.IpGeoCurrencySDK, entopts map[string]any) *ApiJsonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ApiJsonEntity) GetName() string { return e.name }
...
func (e *ApiJsonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApiJsonEntity) Deleted() bool {
	return e.deleted
}


func (e *ApiJsonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewApiJsonEntity(e.client, opts)
}

func (e *ApiJsonEntity) Data(args ...any) any {
...
func (e *ApiJsonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ApiJson; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ApiJsonEntity) DataTyped(data ...ApiJson) ApiJson {
	if len(data) > 0 {
		return typedFrom[ApiJson](e.Data(asMap(data[0])))
	}
	return typedFrom[ApiJson](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ApiJson (all fields
// optional at the wire level).
func (e *ApiJsonEntity) MatchTyped(match ...ApiJson) ApiJson {
	if len(match) > 0 {
		return typedFrom[ApiJson](e.Match(asMap(match[0])))
	}
	return typedFrom[ApiJson](e.Match())
}
...
func (e *ApiJsonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ApiJsonEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ApiJsonLoadMatch and returns an ApiJson. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ApiJsonEntity) LoadTyped(reqmatch ApiJsonLoadMatch, ctrl map[string]any) (ApiJson, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ApiJson{}, err
	}
	return typedFrom[ApiJson](res), nil
}



func (e *ApiJsonEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ApiJsonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ApiJsonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ApiJsonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ApiJsonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
