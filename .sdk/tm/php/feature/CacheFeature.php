...
// IpGeoCurrency SDK cache feature
...
class IpGeoCurrencyCacheFeature extends IpGeoCurrencyBaseFeature
{
    ...
    private function _through(IpGeoCurrencyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
