...
AQL-driven CLI and REPL for the IpGeoCurrency SDK. Positional arguments are
...
```sh
go build -o ip-geo-currency-cli ./...
```
...
./ip-geo-currency-cli list api_json
./ip-geo-currency-cli load 1 api_json
./ip-geo-currency-cli load '{id:1}' api_json
