...
func NewCurrencyRateEntity(client *core.IpGeoCurrencySDK, entopts map[string]any) *CurrencyRateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CurrencyRateEntity) GetName() string { return e.name }
...
func (e *CurrencyRateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CurrencyRateEntity) Deleted() bool {
	return e.deleted
}


func (e *CurrencyRateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCurrencyRateEntity(e.client, opts)
}

func (e *CurrencyRateEntity) Data(args ...any) any {
...
func (e *CurrencyRateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CurrencyRate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CurrencyRateEntity) DataTyped(data ...CurrencyRate) CurrencyRate {
	if len(data) > 0 {
		return typedFrom[CurrencyRate](e.Data(asMap(data[0])))
	}
	return typedFrom[CurrencyRate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CurrencyRate (all fields
// optional at the wire level).
func (e *CurrencyRateEntity) MatchTyped(match ...CurrencyRate) CurrencyRate {
	if len(match) > 0 {
		return typedFrom[CurrencyRate](e.Match(asMap(match[0])))
	}
	return typedFrom[CurrencyRate](e.Match())
}
...
func (e *CurrencyRateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CurrencyRateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CurrencyRateLoadMatch and returns an CurrencyRate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CurrencyRateEntity) LoadTyped(reqmatch CurrencyRateLoadMatch, ctrl map[string]any) (CurrencyRate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CurrencyRate{}, err
	}
	return typedFrom[CurrencyRate](res), nil
}



func (e *CurrencyRateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CurrencyRateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CurrencyRateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CurrencyRateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CurrencyRateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
