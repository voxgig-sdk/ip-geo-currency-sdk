...
// IpGeoCurrency SDK CurrencyRate entity
...
class CurrencyRateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CurrencyRateEntity($this->_client, $opts);
    }

    /**
     * @param CurrencyRate|array $args CurrencyRate data (assoc-array) to store.
     */
    ...
    /**
     * @return CurrencyRate|array The current CurrencyRate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CurrencyRate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CurrencyRate fields).
     */
    ...
    /**
     * Load a single CurrencyRate.
     *
     * @param CurrencyRateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CurrencyRateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CurrencyRate|array The loaded CurrencyRate as an assoc-array at the
