...
(0, node_test_1.describe)('CurrencyRateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-currency_rate', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-currency_rate', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEO_CURRENCY_TEST_CURRENCY_RATE_ENTID'];
...
//# sourceMappingURL=CurrencyRateDirect.test.js.map