...
const testSeed = `map[string]any{"entity": map[string]any{"api_json": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "currency_conversion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "currency_rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "json": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
