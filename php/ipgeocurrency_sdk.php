...
class IpGeoCurrencySDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = IpGeoCurrencyHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = IpGeoCurrencyHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!IpGeoCurrencyFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, IpGeoCurrencyFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return IpGeoCurrencyUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = IpGeoCurrencyHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = IpGeoCurrencyHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = IpGeoCurrencyHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new IpGeoCurrencyError($op . "_allow",
                "IpGeoCurrencySDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = IpGeoCurrencyHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new IpGeoCurrencyError("graphql_error",
                "IpGeoCurrencySDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function ApiJson($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_api_json === null) {
                $this->_api_json = new ApiJsonEntity($this, null);
            }
            return $this->_api_json;
        }
        return new ApiJsonEntity($this, $data);
    }
    ...
    public function CurrencyConversion($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_currency_conversion === null) {
                $this->_currency_conversion = new CurrencyConversionEntity($this, null);
            }
            return $this->_currency_conversion;
        }
        return new CurrencyConversionEntity($this, $data);
    }
    ...
    public function CurrencyRate($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_currency_rate === null) {
                $this->_currency_rate = new CurrencyRateEntity($this, null);
            }
            return $this->_currency_rate;
        }
        return new CurrencyRateEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new IpGeoCurrencySDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
