# IpGeoCurrency Python SDK



The Python SDK for the IpGeoCurrency API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.ApiJson()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/ip-geo-currency-sdk/releases)) or
...
```
py/
├── ipgeocurrency_sdk.py         -- Main SDK module
...
The main module (`ipgeocurrency_sdk`) exports the SDK class.
