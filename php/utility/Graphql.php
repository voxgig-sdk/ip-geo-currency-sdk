...
// IpGeoCurrency SDK utility: graphql
//
...
class IpGeoCurrencyGraphql
{
    ...
    // equivalent.
    public static function body(IpGeoCurrencyContext $ctx): mixed
    {
    ...
    public static function errors(IpGeoCurrencyContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
