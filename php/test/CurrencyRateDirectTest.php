...
class CurrencyRateDirectTest extends TestCase
{
    public function test_direct_load_currency_rate(): void
    {
        $setup = currency_rate_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-currency_rate", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
