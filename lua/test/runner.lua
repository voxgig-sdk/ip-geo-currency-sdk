...
function runner.env_override(m)
  local live = runner.getenv("IPGEOCURRENCY_TEST_LIVE")
  local override = runner.getenv("IPGEOCURRENCY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IPGEOCURRENCY_TEST_EXPLAIN")
