...
from projectname_sdk.core.control import IpGeoCurrencyControl
...
class IpGeoCurrencyContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IpGeoCurrencyControl()
        ...
        if isinstance(sp, IpGeoCurrencySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpGeoCurrencyResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpGeoCurrencyResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IpGeoCurrencyError(code, msg, self)
