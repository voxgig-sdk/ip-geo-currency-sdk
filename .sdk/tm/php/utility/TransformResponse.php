...
// IpGeoCurrency SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class IpGeoCurrencyTransformResponse
{
    public static function call(IpGeoCurrencyContext $ctx): mixed
    {
        ...
        $transform = IpGeoCurrencyHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
