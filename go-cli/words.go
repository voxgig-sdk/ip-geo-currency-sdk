...
func registerSDKWords(r *eng.Registry, client *sdk.IpGeoCurrencySDK) {
...
func runOp(client *sdk.IpGeoCurrencySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
