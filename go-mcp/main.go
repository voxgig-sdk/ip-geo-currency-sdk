// Command IpGeoCurrency-mcp is an MCP server exposing the IpGeoCurrency
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpGeoCurrency_list  — list records of an entity
//	IpGeoCurrency_load  — load a single record of an entity
//
