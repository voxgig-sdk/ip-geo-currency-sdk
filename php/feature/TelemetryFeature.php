...
// IpGeoCurrency SDK telemetry feature
...
class IpGeoCurrencyTelemetryFeature extends IpGeoCurrencyBaseFeature
{
    ...
    private function _close(IpGeoCurrencyContext $ctx, bool $ok): void
    {
