# IpGeoCurrency SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpGeoCurrencySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpGeoCurrencySDK(...) and IpGeoCurrencySDK.test(...) become
#      IpGeoCurrencySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipgeocurrency_sdk"
_SDK_CLASS = "IpGeoCurrencySDK"
