...
local SDK_MODULE = "ip-geo-currency_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["api_json"] = { ["test01"] = { id = "test01" } }, ["currency_conversion"] = { ["test01"] = { id = "test01" } }, ["currency_rate"] = { ["test01"] = { id = "test01" } }, ["json"] = { ["test01"] = { id = "test01" } } } }'
