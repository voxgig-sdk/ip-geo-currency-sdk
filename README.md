...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ip-geo-currency` | `npm install @voxgig-sdk/ip-geo-currency` |
| Python | `voxgig-sdk-ip-geo-currency` | `pip install voxgig-sdk-ip-geo-currency` |
| PHP | `voxgig-sdk/ip-geo-currency` | `composer require voxgig-sdk/ip-geo-currency` |
| Golang | `github.com/voxgig-sdk/ip-geo-currency-sdk/go` | `go get github.com/voxgig-sdk/ip-geo-currency-sdk/go` |
| Ruby | `voxgig-sdk-ip-geo-currency` | `gem install voxgig-sdk-ip-geo-currency` |
| Lua | `voxgig-sdk-ip-geo-currency` | `luarocks install voxgig-sdk-ip-geo-currency` |
