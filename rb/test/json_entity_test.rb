...
class JsonEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IP_GEO_CURRENCY_TEST_JSON_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def json_basic_setup(extra)
  ...
  entid_env_raw = ENV["IP_GEO_CURRENCY_TEST_JSON_ENTID"]
