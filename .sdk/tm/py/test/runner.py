...
class IpGeoCurrencyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpGeoCurrencyTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IpGeoCurrencyTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IpGeoCurrencyTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
