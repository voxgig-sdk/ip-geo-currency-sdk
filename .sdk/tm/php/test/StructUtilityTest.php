...
// IpGeoCurrency SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IpGeoCurrencyOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IpGeoCurrencyOmni::structfix($now, Struct::undef()))
                        !== json_encode(IpGeoCurrencyOmni::structfix($val, Struct::undef()))) {
