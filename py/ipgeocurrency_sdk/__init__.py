...
from ipgeocurrency_sdk.utility import register

# Load features
from ipgeocurrency_sdk.feature.base_feature import IpGeoCurrencyBaseFeature
from ipgeocurrency_sdk.features import _has_feature, _make_feature
...
class IpGeoCurrencySDK:
    ...
    def get_utility(self):
        return IpGeoCurrencyUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpGeoCurrencySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def ApiJson(self, data=None) -> "ApiJsonEntity":
        ...
        from ipgeocurrency_sdk.entity.api_json_entity import ApiJsonEntity
    ...
    def CurrencyConversion(self, data=None) -> "CurrencyConversionEntity":
        ...
        from ipgeocurrency_sdk.entity.currency_conversion_entity import CurrencyConversionEntity
    ...
    def CurrencyRate(self, data=None) -> "CurrencyRateEntity":
        ...
        from ipgeocurrency_sdk.entity.currency_rate_entity import CurrencyRateEntity
        return CurrencyRateEntity(self, data)


    def Json(self, data=None) -> "JsonEntity":
        """Entity factory: client.Json().list() / client.Json().load({"id": ...})."""
        from ipgeocurrency_sdk.entity.json_entity import JsonEntity
