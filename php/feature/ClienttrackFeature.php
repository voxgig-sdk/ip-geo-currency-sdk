...
// IpGeoCurrency SDK clienttrack feature
...
class IpGeoCurrencyClienttrackFeature extends IpGeoCurrencyBaseFeature
{
    ...
    public function PostConstruct(IpGeoCurrencyContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpGeoCurrency-SDK';
