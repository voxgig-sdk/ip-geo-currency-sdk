...
// IpGeoCurrency SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpGeoCurrencySDK::test)
...
{
    private const SDK_CLASS = 'IpGeoCurrencySDK';
    ...
    private const SDK_BASE = 'ipgeocurrency_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipgeocurrency_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
