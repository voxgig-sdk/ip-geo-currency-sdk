...
// IpGeoCurrency SDK utility type

class IpGeoCurrencyUtility
{
    ...
    public static function copy(IpGeoCurrencyUtility $src): IpGeoCurrencyUtility
    {
        $u = new IpGeoCurrencyUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
