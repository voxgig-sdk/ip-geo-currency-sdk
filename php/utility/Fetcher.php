...
// IpGeoCurrency SDK utility: fetcher

class IpGeoCurrencyFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpGeoCurrencySDK/1.0)';
    ...
    public static function call(IpGeoCurrencyContext $ctx, string $fullurl, array $fetchdef): array
    {
