...
type CurrencyConversionEntity struct {
	name    string
	client  *core.IpGeoCurrencySDK
...
func NewCurrencyConversionEntity(client *core.IpGeoCurrencySDK, entopts map[string]any) *CurrencyConversionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CurrencyConversionEntity) GetName() string { return e.name }
...
func (e *CurrencyConversionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CurrencyConversionEntity) Deleted() bool {
	return e.deleted
}


func (e *CurrencyConversionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCurrencyConversionEntity(e.client, opts)
}

func (e *CurrencyConversionEntity) Data(args ...any) any {
...
func (e *CurrencyConversionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CurrencyConversion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CurrencyConversionEntity) DataTyped(data ...CurrencyConversion) CurrencyConversion {
	if len(data) > 0 {
		return typedFrom[CurrencyConversion](e.Data(asMap(data[0])))
	}
	return typedFrom[CurrencyConversion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CurrencyConversion (all fields
// optional at the wire level).
func (e *CurrencyConversionEntity) MatchTyped(match ...CurrencyConversion) CurrencyConversion {
	if len(match) > 0 {
		return typedFrom[CurrencyConversion](e.Match(asMap(match[0])))
	}
	return typedFrom[CurrencyConversion](e.Match())
}
...
func (e *CurrencyConversionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CurrencyConversionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CurrencyConversionLoadMatch and returns an CurrencyConversion. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CurrencyConversionEntity) LoadTyped(reqmatch CurrencyConversionLoadMatch, ctrl map[string]any) (CurrencyConversion, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CurrencyConversion{}, err
	}
	return typedFrom[CurrencyConversion](res), nil
}



func (e *CurrencyConversionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CurrencyConversionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CurrencyConversionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CurrencyConversionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CurrencyConversionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
