...
describe("CurrencyRateDirect", function()
  it("should direct-load-currency_rate", function()
    local setup = currency_rate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-currency_rate", setup.live and "live" or "unit")
...
function currency_rate_direct_setup(mockres)
