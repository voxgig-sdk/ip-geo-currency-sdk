...
class CurrencyRateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CurrencyRateEntity(self._client, opts)
    ...
    def data_get(self) -> CurrencyRate:
    ...
    def match_get(self) -> CurrencyRate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CurrencyRate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CurrencyRate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
