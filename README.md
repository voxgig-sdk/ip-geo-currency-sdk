...
This API provides geolocation information and currency data based on a user's IP address.

Learn more about IP Geo Currency API at [apip.cc](https://apip.cc).
...
This SDK exposes the API as a small set of **semantic entities** — ApiJson, CurrencyConversion, CurrencyRate and Json — that you
