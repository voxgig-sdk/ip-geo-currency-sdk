...
from ipgeocurrency_sdk.ipgeocurrency_types import (
    CurrencyConversion,
...
class CurrencyConversionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CurrencyConversionEntity(self._client, opts)
    ...
    def data_get(self) -> CurrencyConversion:
    ...
    def match_get(self) -> CurrencyConversion:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CurrencyConversion:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CurrencyConversion().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
