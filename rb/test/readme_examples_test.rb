...
#      offline in seeded test mode (IpGeoCurrencySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpGeoCurrency_sdk.rb")
  SDK_CLASS = "IpGeoCurrencySDK"
