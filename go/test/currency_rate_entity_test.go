...
func TestCurrencyRateEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		currencyRateRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.currency_rate")))
...
func currency_rateBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("IP_GEO_CURRENCY_TEST_CURRENCY_RATE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["IP_GEO_CURRENCY_TEST_CURRENCY_RATE_ENTID"])
