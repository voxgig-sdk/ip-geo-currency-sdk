...
local CurrencyConversionEntity = {}
CurrencyConversionEntity.__index = CurrencyConversionEntity


function CurrencyConversionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CurrencyConversionEntity)
  self._name = "currency_conversion"
  self._client = client
...
function CurrencyConversionEntity:get_name()
  return self._name
end


function CurrencyConversionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CurrencyConversionEntity.new(self._client, opts)
end
...
function CurrencyConversionEntity:mark_deleted()
  self._deleted = true
end


function CurrencyConversionEntity:deleted()
  return true == self._deleted
end


function CurrencyConversionEntity:data_set(args)
  if args ~= nil then
...
function CurrencyConversionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CurrencyConversionEntity:match_set(args)
  if args ~= nil then
...
function CurrencyConversionEntity:match_get()
...
function CurrencyConversionEntity:stream(action, args, callopts)
...
---@param reqmatch CurrencyConversionLoadMatch
---@param ctrl? table
---@return CurrencyConversion
---@return string? err
function CurrencyConversionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CurrencyConversionEntity:_run_op(ctx, post_done)
  local utility = self._utility
