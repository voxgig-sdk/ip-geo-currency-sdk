...
The PHP SDK for the IpGeoCurrency API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->ApiJson(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->IpGeoCurrency(null)->load(
    ["id" => "test01"], null
);
