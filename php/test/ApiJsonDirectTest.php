...
class ApiJsonDirectTest extends TestCase
{
    public function test_direct_load_api_json(): void
    {
        $setup = api_json_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-api_json", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
