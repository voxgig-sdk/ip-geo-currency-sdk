...
function runner.env_override(m)
  local live = runner.getenv("IP_GEO_CURRENCY_TEST_LIVE")
  local override = runner.getenv("IP_GEO_CURRENCY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IP_GEO_CURRENCY_TEST_EXPLAIN")
