...
func (sdk *IpGeoCurrencySDK) OptionsMap() map[string]any {
...
func (sdk *IpGeoCurrencySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IpGeoCurrencySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IpGeoCurrencySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpGeoCurrencySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IpGeoCurrencySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IpGeoCurrencySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IpGeoCurrencySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IpGeoCurrencySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpGeoCurrencySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IpGeoCurrencySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *IpGeoCurrencySDK {
	...
	sdk := NewIpGeoCurrencySDK(sdkopts)
	sdk.Mode = "test"
