...
// IpGeoCurrency SDK netsim feature
...
class IpGeoCurrencyNetsimFeature extends IpGeoCurrencyBaseFeature
{
    ...
    private function _simulate(IpGeoCurrencyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpGeoCurrencyContext $ctx, array $applied): void
    {
        $client = $this->client;
