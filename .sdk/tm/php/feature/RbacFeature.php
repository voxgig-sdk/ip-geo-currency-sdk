...
// IpGeoCurrency SDK rbac feature
...
class IpGeoCurrencyRbacFeature extends IpGeoCurrencyBaseFeature
{
    ...
    private function _required(IpGeoCurrencyContext $ctx): ?string
    {
    ...
    private function _reject(IpGeoCurrencyContext $ctx, string $required): void
    {
    ...
    private function _track(IpGeoCurrencyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
