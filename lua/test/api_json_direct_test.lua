...
describe("ApiJsonDirect", function()
  it("should direct-load-api_json", function()
    local setup = api_json_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_json", setup.live and "live" or "unit")
...
function api_json_direct_setup(mockres)
