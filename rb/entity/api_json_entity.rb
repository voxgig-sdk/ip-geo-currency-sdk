...
class ApiJsonEntity
  ...
  def make
    opts = @_entopts.dup
    ApiJsonEntity.new(@_client, opts)
  end
  ...
  # @return [ApiJson, Hash] the current ApiJson data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiJson fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiJsonLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiJson.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiJson, Hash] the loaded ApiJson; raises IpGeoCurrencyError on failure
