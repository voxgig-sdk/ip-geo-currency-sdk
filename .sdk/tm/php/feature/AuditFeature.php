...
// IpGeoCurrency SDK audit feature
...
class IpGeoCurrencyAuditFeature extends IpGeoCurrencyBaseFeature
{
    ...
    private function _emit(IpGeoCurrencyContext $ctx, string $outcome): void
    {
