...
// IpGeoCurrency SDK utility: make_options

class IpGeoCurrencyMakeOptions
{
    ...
    public static function call(IpGeoCurrencyContext $ctx): array
    {
        ...
        //
        // `IpGeoCurrencySchema::optspec()` is built from the model:
        ...
        $optspec = IpGeoCurrencySchema::optspec();
