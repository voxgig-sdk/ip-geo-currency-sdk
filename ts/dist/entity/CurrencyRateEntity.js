...
class CurrencyRateEntity extends IpGeoCurrencyEntityBase_1.IpGeoCurrencyEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'currency_rate';
        this.name_ = 'currency_rate';
        this.Name = 'CurrencyRate';
    }
    make() {
        return new CurrencyRateEntity(this._client, this.entopts());
    }
