...
local CurrencyRateEntity = {}
CurrencyRateEntity.__index = CurrencyRateEntity


function CurrencyRateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CurrencyRateEntity)
  self._name = "currency_rate"
  self._client = client
...
function CurrencyRateEntity:get_name()
  return self._name
end


function CurrencyRateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CurrencyRateEntity.new(self._client, opts)
end
...
function CurrencyRateEntity:mark_deleted()
  self._deleted = true
end


function CurrencyRateEntity:deleted()
  return true == self._deleted
end


function CurrencyRateEntity:data_set(args)
  if args ~= nil then
...
function CurrencyRateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CurrencyRateEntity:match_set(args)
  if args ~= nil then
...
function CurrencyRateEntity:match_get()
...
function CurrencyRateEntity:stream(action, args, callopts)
...
---@param reqmatch CurrencyRateLoadMatch
---@param ctrl? table
---@return CurrencyRate
---@return string? err
function CurrencyRateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CurrencyRateEntity:_run_op(ctx, post_done)
  local utility = self._utility
