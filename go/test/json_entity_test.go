...
func TestJsonEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set IPGEOCURRENCY_TEST_JSON_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func jsonBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("IPGEOCURRENCY_TEST_JSON_ENTID")
