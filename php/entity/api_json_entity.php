...
// IpGeoCurrency SDK ApiJson entity
...
class ApiJsonEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApiJsonEntity($this->_client, $opts);
    }

    /**
     * @param ApiJson|array $args ApiJson data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiJson|array The current ApiJson data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiJson fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiJson fields).
     */
    ...
    /**
     * Load a single ApiJson.
     *
     * @param ApiJsonLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiJsonLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiJson|array The loaded ApiJson as an assoc-array at the
