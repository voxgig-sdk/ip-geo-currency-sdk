...
// IpGeoCurrency SDK ratelimit feature
...
class IpGeoCurrencyRatelimitFeature extends IpGeoCurrencyBaseFeature
{
    ...
    private function _acquire(IpGeoCurrencyContext $ctx): void
    {
    ...
    private function _track(IpGeoCurrencyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
