...
class IpGeoCurrencyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpGeoCurrencyTestRunner.getenv("IPGEOCURRENCY_TEST_LIVE")
        override = IpGeoCurrencyTestRunner.getenv("IPGEOCURRENCY_TEST_OVERRIDE")
        ...
        explain = IpGeoCurrencyTestRunner.getenv("IPGEOCURRENCY_TEST_EXPLAIN")
