...
// IpGeoCurrency SDK idempotency feature
...
class IpGeoCurrencyIdempotencyFeature extends IpGeoCurrencyBaseFeature
{
    ...
    private function _mutating(IpGeoCurrencyContext $ctx): bool
    {
